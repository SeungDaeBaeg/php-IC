...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td><input type="text" name="po_subject" value="<?=get_sanitize_input($po['po_subject']); ?>" id="po_subject" required class="required frm_input" size="80" maxlength="125"></td>
    </tr>
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" name="po_cnt<?=$i ?>" value="<?=$po_cnt; ?>" id="po_cnt<?=$i ?>" class="frm_input" size="3">
       </td>
    </tr>
...
<div class="btn_fixed_top ">
    <a href="./poll_list.php?<?=$qstr ?>" class="btn_02 btn">목록</a>
