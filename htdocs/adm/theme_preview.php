...
<link rel="stylesheet" href="<?=G5_ADMIN_URL; ?>/css/theme.css">
<script src="<?=G5_ADMIN_URL; ?>/theme.js"></script>

<section id="preview_item">
    <ul>
        <li><a href="./theme_preview.php?theme=<?=$theme.$qstr_index; ?>">인덱스 화면</a></li>
        <li><a href="./theme_preview.php?theme=<?=$theme.$qstr_list; ?>">게시글 리스트</a></li>
        <li><a href="./theme_preview.php?theme=<?=$theme.$qstr_view; ?>">게시글 보기</a></li>
        <?php if(defined('G5_USE_SHOP') && G5_USE_SHOP) { ?>
        <?php if(defined('G5_COMMUNITY_USE') == false || G5_COMMUNITY_USE) { ?>
        <li><a href="./theme_preview.php?theme=<?=$theme.$qstr_shop; ?>">쇼핑몰</a></li>
        <?php } ?>
        <li><a href="./theme_preview.php?theme=<?=$theme.$qstr_ca_list; ?>">상품리스트</a></li>
        <li><a href="./theme_preview.php?theme=<?=$theme.$qstr_item; ?>">상품상세</a></li>
        <?php } ?>
        <li><a href="./theme_preview.php?theme=<?=$theme.$qstr_device; ?>"><?=(G5_IS_MOBILE ? 'PC 버전' : '모바일 버전'); ?></a></li>
        <?=$btn_active; ?>
    </ul>
</section>
