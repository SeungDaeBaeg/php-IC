...
<input type="hidden" name="fa_id" value="<?=$fa_id; ?>">
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            ...
            <?php if ($w == 'u') { ?><a href="<?=G5_BBS_URL; ?>/faq.php?fm_id=<?=$fm_id; ?>" class="btn_frmline">내용보기</a><?php } ?>
        </td>
    </tr>
    <tr>
        <th scope="row">질문</th>
        <td><?=editor_html('fa_subject', get_text(html_purifier($fa['fa_subject']), 0)); ?></td>
    </tr>
    <tr>
        <th scope="row">답변</th>
        <td><?=editor_html('fa_content', get_text(html_purifier($fa['fa_content']), 0)); ?></td>
    </tr>
    </tbody>
    </table>
</div>
...
<div class="btn_fixed_top">
    ...
    <a href="./faqlist.php?fm_id=<?=$fm_id; ?>" class="btn btn_02">목록</a>
</div>
