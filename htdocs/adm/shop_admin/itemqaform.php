...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        <th scope="row">이메일</th>
        <td><?=get_text($iq['iq_email']); ?></td>
    </tr>
    <?php } ?>
    <?php if($iq['iq_hp']) { ?>
    <tr>
        <th scope="row">휴대폰</th>
        <td><?=hyphen_hp_number($iq['iq_hp']); ?></td>
    </tr>
    <?php } ?>
    <tr>
    ...
    <tr>
        ...
        <td><?=editor_html('iq_question', get_text(html_purifier($iq['iq_question']), 0)); ?></td>
    </tr>
    <tr>
        <th scope="row"><label for="iq_answer">답변</label></th>
        <td><?=editor_html('iq_answer', get_text(html_purifier($iq['iq_answer']), 0)); ?></td>
...
<div class="btn_fixed_top">
    <a href="./itemqalist.php?<?=$qstr; ?>" class="btn btn_02">목록</a>
...
{
    <?=get_editor_js('iq_question'); ?>
    <?=get_editor_js('iq_answer'); ?>
