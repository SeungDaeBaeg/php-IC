    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <?php if ($w == "") { ?>
                ...
                <input type="text" name="ca_id" value="<?=$subid; ?>" id="ca_id" required class="required frm_input" size="<?=$sublen; ?>" maxlength="<?=$sublen; ?>">
            ...
            <?php } else { ?>
                ...
                <a href="<?=shop_category_url($ca_id); ?>" class="btn_frmline">미리보기</a>
        ...
        <tr>
            ...
            <td><input type="text" name="ca_name" value="<?=$ca['ca_name']; ?>" id="ca_name" size="38" required class="required frm_input"></td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="ca_order" value="<?=$ca['ca_order']; ?>" id="ca_order" class="frm_input" size="12">
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?php if ($is_admin == 'super') { ?>
                    <input type="text" name="ca_mb_id" value="<?=get_sanitize_input($ca['ca_mb_id']); ?>" id="ca_mb_id" class="frm_input" maxlength="20">
                <?php } else { ?>
                    <input type="hidden" name="ca_mb_id" value="<?=get_sanitize_input($ca['ca_mb_id']); ?>">
                    <?=$ca['ca_mb_id']; ?>
                <?php } ?>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?=get_skin_select('shop', 'ca_skin_dir', 'ca_skin_dir', $ca['ca_skin_dir']); ?>
            </td>
        </tr>
        <tr>
            <th scope="row"><label for="ca_mobile_skin_dir">모바일용 스킨명</label></th>
            <td>
                <?=get_mobile_skin_select('shop', 'ca_mobile_skin_dir', 'ca_mobile_skin_dir', $ca['ca_mobile_skin_dir']); ?>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <?=help('기본으로 제공하는 스킨은 '.str_replace(G5_PATH.'/', '', $g5_shop_skin_path).'/list.*.skin.php 입니다.'); ?>
                <select id="ca_skin" name="ca_skin" required class="required">
                    <?=get_list_skin_options("^list.[0-9]+\.skin\.php", $g5_shop_skin_path, $ca['ca_skin']); ?>
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?=help("쇼핑몰환경설정 &gt; 이미지(소) 넓이가 기본값으로 설정됩니다.\n".G5_SHOP_URL."/list.php에서 출력되는 이미지의 폭입니다."); ?>
                <input type="text" name="ca_img_width" value="<?=$ca['ca_img_width']; ?>" id="ca_img_width" required class="required frm_input" size="5" > 픽셀
            </td>
        </tr>
        <tr>
            <th scope="row"><label for="ca_img_height">출력이미지 높이</label></th>
            <td>
                <?=help("쇼핑몰환경설정 &gt; 이미지(소) 높이가 기본값으로 설정됩니다.\n".G5_SHOP_URL."/list.php에서 출력되는 이미지의 높이입니다."); ?>
                <input type="text" name="ca_img_height"  value="<?=$ca['ca_img_height']; ?>" id="ca_img_height" required class="required frm_input" size="5" > 픽셀
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="ca_list_mod" size="3" value="<?=$ca['ca_list_mod']; ?>" id="ca_list_mod" required class="required frm_input"> 개
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="ca_list_row" value='<?=$ca['ca_list_row']; ?>' id="ca_list_row" required class="required frm_input" size="3"> 줄
            </td>
        </tr>
        <tr>
            <th scope="row"><label for="ca_mobile_skin">모바일 출력스킨</label></th>
            <td>
                <?=help('기본으로 제공하는 스킨은 '.str_replace(G5_PATH.'/', '', $g5_mshop_skin_path).'/list.*.skin.php 입니다.'); ?>
                <select id="ca_mobile_skin" name="ca_mobile_skin" required class="required">
                    <?=get_list_skin_options("^list.[0-9]+\.skin\.php", $g5_mshop_skin_path, $ca['ca_mobile_skin']); ?>
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?=help("쇼핑몰환경설정 &gt; 이미지(소) 넓이가 기본값으로 설정됩니다.\n".G5_SHOP_URL."/list.php에서 출력되는 이미지의 폭입니다."); ?>
                <input type="text" name="ca_mobile_img_width" value="<?=$ca['ca_mobile_img_width']; ?>" id="ca_mobile_img_width" required class="required frm_input" size="5" > 픽셀
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?=help("쇼핑몰환경설정 &gt; 이미지(소) 높이가 기본값으로 설정됩니다.\n".G5_SHOP_URL."/list.php에서 출력되는 이미지의 높이입니다."); ?>
                <input type="text" name="ca_mobile_img_height"  value="<?=$ca['ca_mobile_img_height']; ?>" id="ca_mobile_img_height" required class="required frm_input" size="5" > 픽셀
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?=help("한 줄에 설정한 값만큼의 상품을 출력하지만 스킨에 따라 한 줄에 하나의 상품만 출력할 수도 있습니다."); ?>
                <input type="text" name="ca_mobile_list_mod" value='<?=$ca['ca_mobile_list_mod']; ?>' id="ca_mobile_list_mod" required class="required frm_input" size="3"> 개
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?=help("한 페이지에 출력할 이미지 줄 수를 설정합니다.\n한 페이지에서 표시하는 상품수는 (1줄당 이미지 수 x 줄 수) 입니다."); ?>
                <input type="text" name="ca_mobile_list_row" value='<?=$ca['ca_mobile_list_row']; ?>' id="ca_mobile_list_row" required class="required frm_input" size="3"> 줄
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="ca_stock_qty" size="10" value="<?=$ca['ca_stock_qty']; ?>" id="ca_stock_qty" class="frm_input"> 개
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="ca_sell_email" size="40" value="<?=get_sanitize_input($ca['ca_sell_email']); ?>" id="ca_sell_email" class="frm_input">
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="checkbox" name="ca_use" <?=($ca['ca_use']) ? "checked" : ""; ?> value="1" id="ca_use">
                예
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?=help("설정에 체크하시면 쿠폰생성 때 분류 검색 결과에 노출되지 않습니다."); ?>
                <input type="checkbox" name="ca_nocoupon" <?=($ca['ca_nocoupon']) ? "checked" : ""; ?> value="1" id="ca_nocoupon">
                예
            </td>
        </tr>
        </tbody>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <?=editor_html('ca_head_html', get_text(html_purifier($ca['ca_head_html']), 0)); ?>
            </td>
        </tr>
        <tr>
            <th scope="row">하단내용</th>
            <td>
                <?=help("상품리스트 페이지 하단에 출력하는 HTML 내용입니다."); ?>
                <?=editor_html('ca_tail_html', get_text(html_purifier($ca['ca_tail_html']), 0)); ?>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?=help("상품리스트 페이지 상단에 출력하는 HTML 내용입니다."); ?>
                <?=editor_html('ca_mobile_head_html', get_text(html_purifier($ca['ca_mobile_head_html']), 0)); ?>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?=help("상품리스트 페이지 하단에 출력하는 HTML 내용입니다."); ?>
                <?=editor_html('ca_mobile_tail_html', get_text(html_purifier($ca['ca_mobile_tail_html']), 0)); ?>
            </td>
        </tr>
        </tbody>
        </table>
...
<section id="anc_scatefrm_extra">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_extra">
                <label for="ca_<?=$i ?>_subj">여분필드 <?=$i ?> 제목</label>
                <input type="text" name="ca_<?=$i ?>_subj" id="ca_<?=$i ?>_subj" value="<?=get_text($ca['ca_'.$i.'_subj']) ?>" class="frm_input">
                <label for="ca_<?=$i ?>">여분필드 <?=$i ?> 값</label>
                <input type="text" name="ca_<?=$i ?>" value="<?=get_text($ca['ca_'.$i]) ?>" id="ca_<?=$i ?>" class="frm_input">
            </td>
        </tr>
        <?php } ?>
        </tbody>
...
function fcategoryformcheck(f)
{
    ...
    <?=get_editor_js('ca_mobile_head_html'); ?>
    <?=get_editor_js('ca_mobile_tail_html'); ?>
...
function frm_check_file(){
    var ca_include_head = "<?=$ca['ca_include_head']; ?>";
    var ca_include_tail = "<?=$ca['ca_include_tail']; ?>";
