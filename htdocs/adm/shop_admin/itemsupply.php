...
<div class="sit_option_frm_wrapper">
    ...
    <tr>
        <td class="td_chk">
            ...
            <label for="spl_chk_<?=$i; ?>" class="sound_only"><?=$spl_subject.' '.$spl; ?></label>
        ...
        <td class="td_numsmall">
            <label for="spl_price_<?=$i; ?>" class="sound_only">상품금액</label>
            <input type="text" name="spl_price[]" value="<?=$spl_price; ?>" id="spl_price_<?=$i; ?>" class="frm_input" size="5">
        </td>
        <td class="td_num">
            <label for="spl_stock_qty_<?=$i; ?>" class="sound_only">재고수량</label>
            <input type="text" name="spl_stock_qty[]" value="<?=$spl_stock_qty; ?>" id="spl_stock_qty_<?=$i; ?>" class="frm_input" size="5">
        </td>
        <td class="td_num">
            <label for="spl_noti_qty_<?=$i; ?>" class="sound_only">통보수량</label>
            <input type="text" name="spl_noti_qty[]" value="<?=$spl_noti_qty; ?>" id="spl_noti_qty_<?=$i; ?>" class="frm_input" size="5">
        </td>
        <td class="td_mng">
            <label for="spl_use_<?=$i; ?>" class="sound_only">사용여부</label>
            <select name="spl_use[]" id="spl_use_<?=$i; ?>">
                <option value="1" <?=get_selected('1', $spl_use); ?>>사용함</option>
                <option value="0" <?=get_selected('0', $spl_use); ?>>사용안함</option>
            </select>
        </td>
    </tr>
    <?php
    ...
    <tr>
        ...
        <td class="td_numsmall">
            <label for="spl_price_<?=$i; ?>" class="sound_only">상품금액</label>
            <input type="text" name="spl_price[]" value="<?=$spl_price; ?>" id="spl_price_<?=$i; ?>" class="frm_input" size="9">
        </td>
        <td class="td_num">
            <label for="spl_stock_qty_<?=$i; ?>" class="sound_only">재고수량</label>
            <input type="text" name="spl_stock_qty[]" value="<?=$spl_stock_qty; ?>" id="spl_stock_qty_<?=$i; ?>" class="frm_input" size="5">
...
<fieldset>
    <?=help('전체 추가 옵션의 상품금액, 재고/통보수량 및 사용여부를 일괄 적용할 수 있습니다.  단, 체크된 수정항목만 일괄 적용됩니다.'); ?>
