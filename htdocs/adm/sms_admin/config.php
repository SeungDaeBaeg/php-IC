...
<input type="hidden" name="cf_icode_server_ip" value="<?=$config['cf_icode_server_ip']?>">
<input type="hidden" name="cf_sms_use" value="<?=$config['cf_sms_use']?>">
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr class="icode_old_version">
        ...
        <td>
            ...
            <input type="text" name="cf_icode_id" value="<?=$config['cf_icode_id']; ?>" id="cf_icode_id" class="frm_input">
        </td>
    </tr>
    <tr class="icode_old_version">
    ...
    <tr class="icode_old_version">
        ...
        <td>
            ...
            <a href="http://www.icodekorea.com/smsbiz/credit_card_amt.php?icode_id=<?=$config['cf_icode_id']; ?>&amp;icode_passwd=<?=$config['cf_icode_pw']; ?>" target="_blank" class="btn_frmline">충전하기</a>
        </td>
    </tr>
    <?php } ?>
    ...
    <tr>
        ...
        <td>
            <?=help("회신받을 휴대폰 번호를 입력하세요. 회신번호는 발신번호로 사전등록된 번호와 동일해야 합니다.<br>예) 010-123-4567"); ?>
            <input type="text" name="cf_phone" value="<?=isset($sms5['cf_phone']) ? get_sanitize_input($sms5['cf_phone']) : ''; ?>" id="cf_phone" required class="frm_input required" size="13">
        </td>
    </tr>
    </tbody>
    </table>
