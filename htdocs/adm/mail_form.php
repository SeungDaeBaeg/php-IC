...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td><input type="text" name="ma_subject" value="<?=get_sanitize_input($ma['ma_subject']); ?>" id="ma_subject" required class="required frm_input" size="100"></td>
    </tr>
    <tr>
        <th scope="row"><label for="ma_content">메일 내용<strong class="sound_only">필수</strong></label></th>
        <td><?=editor_html("ma_content", get_text(html_purifier($ma['ma_content']), 0)); ?></td>
    </tr>
    </tbody>
    </table>
</div>
...
function fmailform_check(f)
{
    ...
    <?=get_editor_js("ma_content"); ?>
    <?=chk_editor_js("ma_content"); ?>
