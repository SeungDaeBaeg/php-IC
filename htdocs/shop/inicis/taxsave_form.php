...
<div id="scash" class="new_win">
    ...
    <section>
        ...
        <form method="post" action="<?=G5_SHOP_URL; ?>/inicis/taxsave_result.php">
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            <tr>
                ...
                <td><input type="text" name="buyeremail" id="buyeremail" value="<?=$od_email; ?>" required class="required frm_input" size="30"></td>
            </tr>
            <tr>
