...
$sql = " select * from g5_shop_item where it_id = '$it_id' and it_use = '1' ";
$it = sql_fetch($sql);
...
$sql = " select * from g5_shop_cart where od_id = '$cart_id' and it_id = '$it_id' order by io_type asc, ct_id asc ";
$result = sql_query($sql);

// 판매가격
$sql2 = " select ct_price, it_name, ct_send_cost from g5_shop_cart where od_id = '$cart_id' and it_id = '$it_id' order by ct_id asc limit 1 ";
$row2 = sql_fetch($sql2);
