...
<div id="sod_ws">
    ...
    <div class="list_02">
        <ul>
        <?php
        $sql  = " select a.wi_id, a.wi_time, b.* from {$g5['g5_shop_wish_table']} a left join g5_shop_item b on ( a.it_id = b.it_id ) ";
        ...
        <li>
            <div class="sod_ws_img"><a href="<?=shop_item_url($row['it_id']); ?>"><?=$image; ?></a></div>
            <div class="wish_info">
				<div class="wish_chk">
                    <?php
                    // 품절검사
                ...
                <a href="<?=shop_item_url($row['it_id']); ?>" class="info_link"><?=stripslashes($row['it_name']); ?></a>
                <div class="info_date"><?=$row['wi_time']; ?></div>
