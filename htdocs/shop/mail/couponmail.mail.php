...
<head>
<meta charset="utf-8">
<title><?=$config['cf_title']; ?> - 쿠폰발행알림 메일</title>
</head>
...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        <h1 style="margin:0 0 20px;padding:30px 30px 20px;background:#f7f7f7;color:#555;font-size:1.4em">
            <?=$config['cf_title'];?> - 쿠폰발행알림 메일
        </h1>

        <p style="<?=$cont_st; ?>"><b><?=$mb_name; ?></b> 님께 발행된 쿠폰입니다.</p>

        <p style="<?=$cont_st; ?>"><?=$contents; ?></p>

        <a href="<?=G5_URL; ?>" target="_blank" style="<?=$ft_a_st; ?>"><?=$config['cf_title']; ?> 바로가기</a>
