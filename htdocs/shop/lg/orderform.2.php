...
<input type="hidden" name="LGD_OID"                     id="LGD_OID"            value="<?=$od_id; ?>">             <!-- 주문번호 -->
<input type="hidden" name="LGD_BUYER"                   id="LGD_BUYER"          value="">                                  <!-- 구매자 -->
<input type="hidden" name="LGD_PRODUCTINFO"             id="LGD_PRODUCTINFO"    value="<?=$goods; ?>">             <!-- 상품정보 -->
...
<input type="hidden" name="LGD_TAXFREEAMOUNT"           id="LGD_TAXFREEAMOUNT"  value="<?=$comm_free_mny; ?>">     <!-- 결제금액 중 면세금액 -->
...
<input type="hidden" name="LGD_CUSTOM_USABLEPAY"        id="LGD_CUSTOM_USABLEPAY"   value="<?=$LGD_CUSTOM_USABLEPAY; ?>">   <!-- 결제가능수단 -->
