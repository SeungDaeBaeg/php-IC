...
<section id="poll">
    <header>
        <h2>설문조사</h2>
		<?php if ($is_admin == "super") {  ?><a href="<?=G5_ADMIN_URL ?>/poll_form.php?w=u&amp;po_id=<?=$po_id ?>" class="btn_admin" title="설문관리"><i class="fa fa-cog fa-spin fa-fw"></i><span class="sound_only">설문관리</span></a><?php }  ?>
    	<a href="<?=G5_BBS_URL."/poll_result.php?po_id=$po_id&amp;skin_dir=".urlencode($skin_dir); ?>" target="_blank" onclick="poll_result(this.href); return false;" class="btn_result">결과보기</a>
    </header>
    <div class="poll_con">
        <p><?=$po['po_subject'] ?></p>
        <ul>
