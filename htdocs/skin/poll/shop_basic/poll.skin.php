...
<section id="poll">
    <header>
        <h2>설문조사</h2>
		<?php if ($is_admin == "super") {  ?><a href="<?=G5_ADMIN_URL ?>/poll_form.php?w=u&amp;po_id=<?=$po_id ?>" class="btn_admin"><i class="fa fa-cog fa-spin fa-fw"></i><span class="sound_only">설문관리</span></a><?php }  ?>
