...
<button type="button" class="cmt_btn"><span class="total"><b>댓글</b> <?=$view['wr_comment']; ?></span><span class="cmt_more"></span></button>
<!-- 댓글 시작 { -->
<section id="bo_vc">
    <h2>댓글목록</h2>
    <?php
	...
	<article id="c_<?=$comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?=$cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        <div class="pf_img"><?=get_member_profile_img($list[$i]['mb_id']) ?></div>
