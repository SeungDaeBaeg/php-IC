...
<div id="sit_ov_from">
	...
	<div id="sit_ov_wrap">
	    ...
	    <div id="sit_pvi">
	        ...
	        ?>
	        <a href="<?=G5_SHOP_URL; ?>/largeimage.php?it_id=<?=$it['it_id']; ?>&amp;no=1" target="_blank" id="popup_item_image" class="popup_item_image"><i class="fa fa-search-plus" aria-hidden="true"></i><span class="sound_only">확대보기</span></a>
	        </div>
	        <?php
	        // 썸네일
	        $thumb1 = true;
	    ...
	    <section id="sit_ov" class="2017_renewal_itemform">
	        ...
	        <div id="sit_star_sns">
	            ...
	            <span class="sound_only">별<?=$star_score?>개</span>
	            <?php } ?>
	            
	            <span class="">사용후기 <?=$it['it_use_cnt']; ?> 개</span>
	        ...
	        <div id="sit_ov_btn">
	            ...
	            <?php } ?>
	            <a href="javascript:item_wish(document.fitem, '<?=$it['it_id']; ?>');" class="sit_btn_wish"><i class="fa fa-heart-o" aria-hidden="true"></i><span class="sound_only">위시리스트</span></a>
	            	
	            <?php if(!$is_orderable && $it['it_soldout'] && $it['it_stock_sms']) { ?>
	            <a href="javascript:popup_stocksms('<?=$it['it_id']; ?>');" id="sit_btn_alm">재입고알림</a>
	            <?php } ?>
