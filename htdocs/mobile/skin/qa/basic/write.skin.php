...
<section id="bo_w">
    ...
    <div class="form_01">
        <ul>
            ...
            <li class="bo_w_tit">
                ...
                <input type="text" name="qa_subject" value="<?=get_text($write['qa_subject']); ?>" id="qa_subject" required class="frm_input full_input required" maxlength="255" placeholder="제목">
            </li>
            ...
            <li class="bo_w_flie">
                <div class="file_wr filebox">
                    ...
                    <input type="file" name="bf_file[1]" id="bf_file[1]" title="파일첨부 1 :  용량 <?=$upload_max_filesize; ?> 이하만 업로드 가능" class="frm_file uploadBtn">
                	<?php if($w == 'u' && $write['qa_file1']) { ?>
                		<input type="checkbox" id="bf_file_del1" name="bf_file_del[1]" value="1">
                		<label for="bf_file_del1"><?=$write['qa_source1']; ?> 파일 삭제</label>
                	<?php } ?>
                </div>
				<br>
                <div class="file_wr filebox">
                    ...
                    <input type="file" name="bf_file[2]" id="bf_file[2]" title="파일첨부 2 :  용량 <?=$upload_max_filesize; ?> 이하만 업로드 가능" class="frm_file uploadBtn">
                    <?php if($w == 'u' && $write['qa_file2']) { ?>
                    <input type="checkbox" id="bf_file_del2" name="bf_file_del[2]" value="1">
                    <label for="bf_file_del2"><?=$write['qa_source2']; ?> 파일 삭제</label>
                    <?php } ?>
                </div>
            </li>
    ...
    <div class="btn_confirm">
        <a href="<?=$list_href; ?>" class="btn_cancel">취소</a>
