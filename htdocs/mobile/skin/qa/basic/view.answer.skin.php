...
<section id="bo_v_ans" class="bo_v_wr">
    <h2>
    	...
    	<span class="tit_cnt"><?=get_text($answer['qa_subject']); ?></span>
    	<div id="ans_datetime">
    ...
    <div id="ans_add" class="ans_more_opt">
        ...
        <a href="<?=$answer_update_href; ?>">답변수정</a>
        <?php } ?>
        <?php if($answer_delete_href) { ?>
        <a href="<?=$answer_delete_href; ?>" onclick="del(this.href); return false;">답변삭제</a>
        <?php } ?>
    </div>
</section>
<a href="<?=$rewrite_href; ?>" class="add_qu">추가질문</a>
