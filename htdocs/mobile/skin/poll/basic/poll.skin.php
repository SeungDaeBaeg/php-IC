...
<aside id="poll">
    <header>
        ...
        <?php if ($is_admin == "super") { ?><a href="<?=G5_ADMIN_URL ?>/poll_form.php?w=u&amp;po_id=<?=$po_id ?>" class="btn_admin btn"><i class="fa fa-cog fa-spin fa-fw"></i><span class="sound_only">관리자 관리</span></a><?php } ?>
    </header>
    <div class="poll_con">
	    <p><?=$po['po_subject'] ?></p>
	    <ul>
