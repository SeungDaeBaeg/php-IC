...
<div id="sps_sch">
    <div class="sch_wr">
        ...
        <input type="text" name="stx" value="<?=$stx; ?>" id="stx" required class="sch_input" size="10">
...
<div id="sps">
    ...
    <li>
        ...
        <section class="sps_section">
			<div class="sps_star">
				<span class="sound_only">평가점수</span><img src="<?=G5_SHOP_URL; ?>/img/s_star<?=$star; ?>.png" alt="별<?=$star; ?>개" width="80">
			</div>

			<div class="sps_con_btn">
				<button class="sps_con_<?=$i; ?> review_detail"><?=get_text($row['is_subject']); ?></button>
				<!-- 사용후기 자세히 시작 -->
	            		...
	            		<div class="review_cnt">
	            			<div class="review_tp_cnt">
	            				...
	            				<dl class="sps_dl">
					                ...
					                <dd class="sps_dd_wt"><?=$row['is_name']; ?></dd>
			...
			<div class="sps_info">
                ...
                <span class="sps_if_wt"><?=get_text($row['is_name']); ?></span>
                <span class="sound_only">작성일</span>
                <span><?=substr($row['is_time'],2,8); ?></span>
    		</div>
        </section>
    </li>
