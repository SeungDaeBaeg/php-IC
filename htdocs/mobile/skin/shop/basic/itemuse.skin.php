...
<div id="sit_use_wbtn">
    <a href="<?=$itemuse_form; ?>" class="qa_wr itemuse_form " onclick="return false;">사용후기 쓰기<span class="sound_only"> 새 창</span></a>
    <a href="<?=$itemuse_list; ?>" id="itemuse_list" class="btn01">더보기</a>
</div>
