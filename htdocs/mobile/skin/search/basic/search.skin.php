...
<section id="sch_res_ov">
    <h2>전체검색 결과</h2>
    <ul>
        <li>게시판<strong><?=$board_count ?>개</strong></li>
        <li>게시물<strong><?=number_format($total_count) ?>개</strong></li>
...
<div id="sch_result">
    ...
    for ($idx=$table_index, $k=0; $idx<count($search_table) && $k<$rows; $idx++) {
     ?>
        ...
        <div class="sch_more"><a href="<?=get_pretty_url($search_table[$idx], '', $search_query); ?>"><strong><?=$bo_subject[$idx] ?></strong> 결과 더보기</a></div>
    <?php }  ?>
