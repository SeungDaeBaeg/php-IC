...
?>
<h1><?=G5_VERSION; ?> 프로그램이 이미 설치되어 있습니다.</h1>
...
{
?>
<h1><?=G5_VERSION; ?> 설치를 위해 아래 내용을 확인해 주십시오.</h1>

<div class="ins_inner">
    <p>
        루트 디렉토리에 아래로 <?=G5_DATA_DIR ?> 디렉토리를 생성하여 주십시오.<br />
        (common.php 파일이 있는곳이 루트 디렉토리 입니다.)<br /><br />
        $> mkdir <?=G5_DATA_DIR ?><br /><br />
...
if (strtoupper(substr(PHP_OS, 0, 3)) !== 'WIN') {
    ...
    if (substr($sapi_type, 0, 3) == 'cgi') {
        ...
        <div class="ins_inner">
            <p>
                <?=G5_DATA_DIR ?> 디렉토리의 퍼미션을 705로 변경하여 주십시오.<br /><br />
                $> chmod 705 <?=G5_DATA_DIR ?> 또는 chmod uo+rx <?=G5_DATA_DIR ?><br /><br />
                위 명령 실행후 브라우저를 새로고침 하십시오.
            </p>
        </div>
        <?php
        ...
        <div class="ins_inner">
            <p>
                <?=G5_DATA_DIR ?> 디렉토리의 퍼미션을 707로 변경하여 주십시오.<br /><br />
                $> chmod 707 <?=G5_DATA_DIR ?> 또는 chmod uo+rwx <?=G5_DATA_DIR ?><br /><br />
                위 명령 실행후 브라우저를 새로고침 하십시오.
            </p>
        </div>
        <?php
