...
<aside id="poll">
    <header>
        ...
        <?php if ($is_admin == "super") { ?><a href="<?=G5_ADMIN_URL ?>/poll_form.php?w=u&amp;po_id=<?=$po_id ?>" class="btn_admin">설문조사 관리</a><?php } ?>
        <p><?=$po['po_subject'] ?></p>
    </header>
    <ul>
    ...
    <footer>
        ...
        <a href="<?=G5_BBS_URL."/poll_result.php?po_id=$po_id&amp;skin_dir=".urlencode($skin_dir); ?>" target="_blank" onclick="poll_result(this.href); return false;" class="btn btn_b01">결과보기</a>
    </footer>
</aside>
</form>
