...
<div id="sit_use_list">
    ...
    ?>
        ...
        <li class="sit_use_li">
            <button type="button" class="sit_use_li_title"><?=$is_subject; ?></button>
             <dl class="sit_use_dl">
                <dt>작성자</dt>
                <dd><?=$is_name; ?></dd>
                <dt>작성일</dt>
                ...
                <dt>선호도<dt>
                <dd class="sit_use_star"><img src="<?=G5_SHOP_URL; ?>/img/s_star<?=$is_star; ?>.png" alt="별<?=$is_star; ?>개"></dd>
            </dl>
...
<div id="sit_use_wbtn">
    <a href="<?=$itemuse_form; ?>" class="qa_wr btn_b02 itemuse_form btn_m" onclick="return false;">사용후기 쓰기<span class="sound_only"> 새 창</span></a>
    <a href="<?=$itemuse_list; ?>" id="itemuse_list" class="btn_b01 btn btn_m">더보기</a>
</div>
