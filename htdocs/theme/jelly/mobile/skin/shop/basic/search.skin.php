    ...
    <div id="ssch_frm">
        ...
        <div class="ssch_scharea">
            ...
            <div class="ssch_right">
                ...
                <input type="text" name="qfrom" value="<?=$qfrom; ?>" id="ssch_qfrom" class="ssch_input" size="8"> 원 ~
                <label for="ssch_qto" class="sound_only">최대 가격</label>
                <input type="text" name="qto" value="<?=$qto; ?>" id="ssch_qto" class="ssch_input" size="8"> 원
                </span>
            </div>
            <div class="ssch_left">
