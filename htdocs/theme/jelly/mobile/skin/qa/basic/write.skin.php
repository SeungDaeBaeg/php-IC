...
<section id="bo_w">
    ...
    <div class="form_01">
        <ul>
            ...
            <li>
                ...
                <input type="email" name="qa_email" value="<?=get_text($write['qa_email']); ?>" id="qa_email" <?=$req_email; ?> class="<?=$req_email.' '; ?>frm_input full_input email" maxlength="100" placeholder="이메일">
            ...
            <li>
                ...
                <input type="text" name="qa_subject" value="<?=get_text($write['qa_subject']); ?>" id="qa_subject" required class="frm_input required" maxlength="255" placeholder="제목">
            </li>
            ...
            <li class="bo_w_flie">
                <div class="file_wr">
                    ...
                    <input type="file" name="bf_file[1]" title="파일첨부 1 :  용량 <?=$upload_max_filesize; ?> 이하만 업로드 가능" class="frm_file">
            ...
            <li class="bo_w_flie">
                <div class="file_wr">
                    ...
                    <input type="file" name="bf_file[2]" title="파일첨부 2 :  용량 <?=$upload_max_filesize; ?> 이하만 업로드 가능" class="frm_file">
    ...
    <div class="btn_top">
        <a href="<?=$list_href; ?>" class="btn_m btn_b01">목록</a>
