    ...
    <div class="form_01">
        ...
        <ul>
            <li>
                ...
                <input type="text" name="me_recv_mb_id" value="<?=$me_recv_mb_id ?>" id="me_recv_mb_id" required class="frm_input required" placeholder="받는 회원아이디">
            ...
            <li>
                ...
                <textarea name="me_memo" id="me_memo" required><?=$content ?></textarea>
            </li>
            <li>
