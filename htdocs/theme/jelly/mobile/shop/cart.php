...
<div id="sod_bsk">
                ...
                <div class="li_wr">
                    ...
                    <div class="li_name">
                        <span class="li_chk bo_chk">
                            <label for="ct_chk_<?=$i; ?>"><span class="chk_img"></span> <span class="sound_only">상품선택</span></label>
                            <input type="checkbox" name="ct_chk[<?=$i; ?>]" value="1" id="ct_chk_<?=$i; ?>" checked>
                        </span>
                        <?=$it_name; ?>
                    ...
                    <div class="total_img"><?=$image; ?></div>
                     ...
                     <ul class="li_prqty">
                        <li class="prqty_price li_prqty_sp"><span>판매가 </span><?=number_format($row['ct_price']); ?></li>
                        <li class="prqty_qty li_prqty_sp"><span>수량 </span><?=number_format($sum['qty']); ?></li>
                        <li class="prqty_sc li_prqty_sp"><span>배송비 </span><?=$ct_send_cost; ?></li>
                        <li class="total_point li_prqty_sp"><span>적립포인트 </span><strong><?=number_format($sum['point']); ?></strong></li>
                    </ul>
    ...
    <div class="sod_ta_wr">
        <?php if ($i == 0) { ?>
        <div class="go_shopping"><a href="<?=G5_SHOP_URL; ?>/" class="btn_b01">쇼핑 계속하기</a></div>
        <?php } else { ?>
