...
<div id="bo_list">
    ...
    <div id="bo_btn_top">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="<?=$write_href ?>" class="btn_b02 btn"><i class="fa fa-pencil" aria-hidden="true"></i> 문의등록</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <!-- } 게시판 페이지 정보 및 버튼 끝 -->
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_stat"><span class=" <?=($list[$i]['qa_status'] ? 'txt_done' : 'txt_rdy'); ?>"><?=($list[$i]['qa_status'] ? '<i class="fa fa-check-circle" aria-hidden="true"></i> 답변완료' : '<i class="fa fa-times-circle" aria-hidden="true"></i> 답변대기'); ?></span></td>
        </tr>
        <?php
        }
        ?>
    ...
    <fieldset id="bo_sch">
        ...
        <input type="text" name="stx" value="<?=stripslashes($stx) ?>" id="stx" required  class="sch_input" size="25" maxlength="15">
