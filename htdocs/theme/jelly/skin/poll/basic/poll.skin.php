...
<section id="poll">
    ...
    <div class="poll_con">
        ...
        <div id="poll_btn">
            <a href="<?=G5_BBS_URL."/poll_result.php?po_id=$po_id&amp;skin_dir=".urlencode($skin_dir); ?>" target="_blank" onclick="poll_result(this.href); return false;" class="btn_result btn_b04">결과보기</a>
