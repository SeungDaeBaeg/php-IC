...
<section id="poll">
    <header>
        ...
        <?php if ($is_admin == "super") {  ?><a href="<?=G5_ADMIN_URL ?>/poll_form.php?w=u&amp;po_id=<?=$po_id ?>" class="btn_admin">설문관리</a><?php }  ?>
    </header>
    <div class="poll_con">
        <p><?=$po['po_subject'] ?></p>
        <ul>
        ...
        <div id="poll_btn">
            ...
            <a href="<?=G5_BBS_URL."/poll_result.php?po_id=$po_id&amp;skin_dir=".urlencode($skin_dir); ?>" target="_blank" onclick="poll_result(this.href); return false;" class="btn_result btn_b01">결과보기</a>
        </div>
    </div>
</section>
</form>
