    ...
    <div>
        ...
        <ul>
            <li>
                ...
                <input type="text" name="mb_id" value="<?=$member['mb_id'] ?>" id="reg_mb_id" <?=$required ?> <?=$readonly ?> class="frm_input half_input <?=$required ?> <?=$readonly ?>" minlength="3" maxlength="20" placeholder="아이디">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <ul>
            <li>
                ...
                <input type="text" id="reg_mb_name" name="mb_name" value="<?=get_text($member['mb_name']) ?>" <?=$required ?> <?=$readonly; ?> class="frm_input half_input <?=$required ?> <?=$readonly ?>" size="10" placeholder="이름">
                <?php
            ...
            <li>
                <label for="reg_mb_nick" class="sound_only">닉네임<strong>필수</strong></label>
                    ...
                    <input type="text" name="mb_nick" value="<?=isset($member['mb_nick'])?get_text($member['mb_nick']):''; ?>" id="reg_mb_nick" required class="frm_input required nospace  half_input" size="10" maxlength="20" placeholder="닉네임">
            ...
            <?php if ($config['cf_use_tel']) {  ?>
                ...
                <input type="text" name="mb_tel" value="<?=get_text($member['mb_tel']) ?>" id="reg_mb_tel" <?=$config['cf_req_tel']?"required":""; ?> class="frm_input half_input <?=$config['cf_req_tel']?"required":""; ?>" maxlength="20" placeholder="전화번호">
            <?php }  ?>

            <?php if ($config['cf_use_hp'] || $config['cf_cert_hp']) {  ?>
                <label for="reg_mb_hp" class="sound_only">휴대폰번호<?php if ($config['cf_req_hp']) { ?><strong>필수</strong><?php } ?></label>
                
                <input type="text" name="mb_hp" value="<?=get_text($member['mb_hp']) ?>" id="reg_mb_hp" <?=($config['cf_req_hp'])?"required":""; ?> class="frm_input right_input half_input <?=($config['cf_req_hp'])?"required":""; ?>" maxlength="20" placeholder="휴대폰번호">
