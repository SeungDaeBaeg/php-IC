...
<div id="memo_list" class="new_win">
    ...
    <div class="new_win_con">
        ...
        <div class="list_01">
            ...
            <li>
                <span class="memo_name"><a href="<?=$list[$i]['view_href'] ?>"><?=$list[$i]['mb_nick'] ?></a></span>
                <span class="memo_datetime"><?=$list[$i]['send_datetime'] ?> - <?=$list[$i]['read_datetime'] ?> <a href="<?=$list[$i]['del_href'] ?>" onclick="del(this.href); return false;" class="memo_del"><i class="fa fa-times-circle" aria-hidden="true"></i> <span class="sound_only">삭제</span></a></span>
            </li>
            <?php }  ?>
