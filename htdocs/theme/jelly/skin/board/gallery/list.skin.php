...
<div id="bo_gall" style="width:<?=$width; ?>">
        ...
        <li class="<?=implode(' ', $classes); ?>">
            <div class="gall_box">
                ...
                <div class="gall_con">
                    ...
                    <div class="gall_info">
                        <span class="sound_only">조회 </span><i class="fa fa-eye" aria-hidden="true"></i> <?=$list[$i]['wr_hit'] ?>
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php } ?>
            <?php if ($list_href) { ?><li><a href="<?=$list_href ?>" class="btn_b01 btn">목록</a></li><?php } ?>
            <?php if ($write_href) { ?><li><a href="<?=$write_href ?>" class="btn_b02 btn">글쓰기</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <?php } ?>
