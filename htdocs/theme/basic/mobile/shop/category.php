...
<div id="category" class="menu">
    <div class="menu_wr">
        <?=outlogin('theme/shop_basic'); // 외부 로그인 ?>
                        ...
                        <li>
                            ...
                            ?>
                                <li>
                                    ...
                                    ?>
                                        <li>
                                            <a href="<?=shop_category_url($mshop_ca_row4['ca_id']); ?>"><?=get_text($mshop_ca_row4['ca_name']); ?></a>
                                            <?php
                                            ...
                                            ?>
                                                <li>
                                                    <a href="<?=shop_category_url($mshop_ca_row5['ca_id']); ?>"><?=get_text($mshop_ca_row5['ca_name']); ?></a>
                                                </li>
                                            <?php
                                            }
