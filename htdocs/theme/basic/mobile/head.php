...
<header id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <div id="gnb" class="hd_div">
            ...
            <ul id="hd_nb">
            	<li class="hd_nb1"><a href="<?=G5_BBS_URL ?>/faq.php" id="snb_faq"><i class="fa fa-question" aria-hidden="true"></i>FAQ</a></li>
                <li class="hd_nb2"><a href="<?=G5_BBS_URL ?>/qalist.php" id="snb_qa"><i class="fa fa-comments" aria-hidden="true"></i>1:1문의</a></li>
                <li class="hd_nb3"><a href="<?=G5_BBS_URL ?>/current_connect.php" id="snb_cnt"><i class="fa fa-users" aria-hidden="true"></i>접속자 <span><?=connect('theme/basic'); // 현재 접속자수 ?></span></a></li>
                <li class="hd_nb4"><a href="<?=G5_BBS_URL ?>/new.php" id="snb_new"><i class="fa fa-history" aria-hidden="true"></i>새글</a></li>   
            </ul>
        </div>
...
<div id="wrapper">
    ...
    <?php if (!defined("_INDEX_")) { ?>
    	<h2 id="container_title" class="top" title="<?=get_text($g5['title']); ?>">
    		<a href="javascript:history.back();"><i class="fa fa-chevron-left" aria-hidden="true"></i><span class="sound_only">뒤로가기</span></a> <?=get_head_title($g5['title']); ?>
    	</h2>
    <?php }