    ...
    <div class="form_01">
        <ul>
            <li>
                ...
                <input type="checkbox" name="iq_secret" id="iq_secret" value="1" <?=$chk_secret; ?>>
                <label for="iq_secret">비밀글</label>
            </li>
            <li>
                <label for="iq_email" class="sound_only">이메일</label>
                <input type="email" name="iq_email" id="iq_email" value="<?=get_text($qa['iq_email']); ?>" class="frm_input full_input" size="30" placeholder="이메일"> <span class="frm_info ">이메일을 입력하시면 답변 등록 시 답변이 이메일로 전송됩니다.</span>
            </li>
            <li>
                <label for="iq_hp" class="sound_only">휴대폰</label>
                <input type="text" name="iq_hp" id="iq_hp" value="<?=get_text($qa['iq_hp']); ?>" class="frm_input full_input" size="20" placeholder="휴대폰"> <span class="frm_info ">휴대폰번호를 입력하시면 답변 등록 시 답변등록 알림이 SMS로 전송됩니다.</span>
            </li>
            <li>
                <label for="iq_subject" class="sound_only">제목</label>
                <input type="text" name="iq_subject" value="<?=get_text($qa['iq_subject']); ?>" id="iq_subject" required class="required frm_input full_input" minlength="2" maxlength="250" placeholder="제목">
            </li>
            <li>
