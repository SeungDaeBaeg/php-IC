...
<div id="sit_ov_wrap">
    ...
    <section id="sit_ov" class="2017_renewal_itemform">
        ...
        <div class="sit_ov_wr">
            ...
            <?php if($it['it_basic']) { ?><p id="sit_desc"><?=$it['it_basic']; ?></p><?php } ?>
            <?php if($is_orderable) { ?>
            <p id="sit_opt_info">상품 선택옵션 <?=$option_count; ?> 개, 추가옵션 <?=$supply_count; ?> 개</p>
            <?php } ?>
            ...
            <div id="sit_star_sns">
                ...
                <span class="sound_only">고객평점 <?=$score?>개</span>
                <img src="<?=G5_SHOP_URL; ?>/img/s_star<?=$score?>.png" alt="" class="sit_star" width="100">
                <span class="review_num">사용후기 <?=$it['it_use_cnt']; ?> 개</span>
                <?php } ?>

                <div class="sit_btn_opt">
                    <span id="btn_wish"><i class="fa fa-heart-o" aria-hidden="true"></i><span class="sound_only">위시리스트</span><span class="btn_wish_num"><?=get_wishlist_count_by_item($it['it_id']); ?></span></span>
            ...
            <div class="sit_ov_tbl">
                ...
                <tr>
                    ...
                    <td><?=display_price($it['it_cust_price']); ?></td>
                </tr>
                <?php } ?>
                <tr>
                    <th scope="row">판매가격</th>
        ...
        <div id="sit_siblings">
            ...
            ?>
            <a href="<?=G5_SHOP_URL; ?>/largeimage.php?it_id=<?=$it['it_id']; ?>&amp;no=1" target="_blank" class="popup_item_image "><i class="fa fa-search-plus" aria-hidden="true"></i><span class="sound_only">확대보기</span></a>
        </div>
        <!-- } 다른 상품 보기 끝 -->
    </section>
</div>
...
<div id="btn_option">
    <div class="sl_option">
        ...
        <div id="sit_ov_btn">
            ...
            <a href="javascript:popup_stocksms('<?=$it['it_id']; ?>');" id="sit_btn_phone">재입고알림</a>
            <?php } ?>
            <a href="javascript:item_wish(document.fitem, '<?=$it['it_id']; ?>');" id="sit_btn_wish"><span class="sound_only">위시리스트</span><i class="fa fa-heart-o" aria-hidden="true"></i></a>
...
<section id="sit_rel">
    ...
    <div class="sct_wrap">
        ...
        $sql = " select b.* from {$g5['g5_shop_item_relation_table']} a left join g5_shop_item b on (a.it_id2=b.it_id) where a.it_id = '{$it['it_id']}' and b.it_use='1' ";
...
function popup_item_recommend(it_id)
{
    if (!g5_is_member)
    {
        if (confirm("회원만 추천하실 수 있습니다."))
            document.location.href = "<?=G5_BBS_URL; ?>/login.php?url=<?=urlencode(shop_item_url($it_id)); ?>";
    }
    else
    {
