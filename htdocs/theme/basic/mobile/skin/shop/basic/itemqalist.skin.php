    ...
    <li>
        ...
        <section class="sqa_section">
            ...
            <div class="sqa_info">
                ...
                <span class="sqa_if_wt"><?=get_text($row['iq_name']); ?></span>
                <span class="sound_only">작성일</span>
                <span><?=substr($row['iq_time'],2,8); ?></span>
            </div>
        </section>
		...
		<div class="sqa_con_btn"><button class="sqa_con_<?=$i; ?>"><span class="sound_only">내용보기</span><i class="fa fa-chevron-down" aria-hidden="true"></i></button></div>
