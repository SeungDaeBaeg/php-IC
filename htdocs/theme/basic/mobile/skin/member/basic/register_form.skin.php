...
<div class="register">
    ...
    <div class="form_01">
        ...
        <ul>
	        ...
	        <li>
	            ...
	            <input type="text" name="mb_homepage" value="<?=get_text($member['mb_homepage']) ?>" id="reg_mb_homepage" class="frm_input full_input <?=$config['cf_req_homepage']?"required":""; ?>" maxlength="255" <?=$config['cf_req_homepage']?"required":""; ?> placeholder="홈페이지">
	        </li>
	        <?php } ?>
    ...
    <div class="form_01">  
		...
		<ul>
	        ...
	        <li class="reg_mb_img_file filebox">
	            ...
	            <span class="frm_info">
	                이미지 크기는 가로 <?=$config['cf_member_img_width'] ?>픽셀, 세로 <?=$config['cf_member_img_height'] ?>픽셀 이하로 해주세요.<br>
    ...
    $(function() {
        ...
        $("#win_hp_cert").click(function(e) {
            ...
            certify_win_open("<?=$cert_type; ?>", "<?=$cert_url; ?>", e);
            return;
        });
        <?php } ?>
    });
