...
<div id="point" class="new_win">
    ...
    <div class="new_win_con2">
        <ul class="point_all">
        	<li class="full_li">
        		보유포인트
        		<span><?=number_format($member['mb_point']); ?></span>
        	</li>
		</ul>
        <ul class="point_list">
            <?php
    ...
    //            if($row['po_expired'] == 1)
                    $expr = ' txt_expired';
            ?>
            <li class="<?=$point_use_class; ?>">
                <div class="point_top">
                    <span class="point_tit"><?=$po_content; ?></span>
                    <span class="point_num"><?php if ($point1) echo $point1; else echo $point2; ?></span>
                </div>
                <span class="point_date1"><i class="fa fa-clock-o" aria-hidden="true"></i> <?=conv_date_format('y-m-d H시', $row['po_datetime']); ?></span>
