        ...
        <section id="poll_result_cmt">
            ...
            <article>
                <header>
                    ...
                    <?=$list2[$i]['name'] ?>
                    <span class="poll_datetime"><i class="fa fa-clock-o" aria-hidden="true"></i> <?=$list2[$i]['datetime'] ?></span>
