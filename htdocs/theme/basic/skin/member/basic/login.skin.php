...
<div id="mb_login" class="mbskin">
        ...
        <fieldset id="login_fs">
            ...
            <div id="login_info">
                ...
                <div class="login_if_lpl">
                    <a href="<?=G5_BBS_URL ?>/password_lost.php" target="_blank" id="login_password_lost">정보찾기</a>
                </div>
            </div>
        </fieldset> 
        </form>
    ...
    <section id="mb_login_notmb">
        ...
        <div id="guest_privacy">
            <?=conv_content($default['de_guest_privacy'], $config['cf_editor']); ?>
        </div>
    ...
    <div id="mb_login_od_wr">
        ...
        <fieldset id="mb_login_od">
            ...
            <input type="text" name="od_id" value="<?=get_text($od_id); ?>" id="od_id" required class="frm_input required" size="20" placeholder="주문서번호">
