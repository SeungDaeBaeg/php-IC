...
<div id="sqa_sch">
    ...
    <select name="sfl" id="sfl" required>
        ...
        <option value="a.iq_name"    <?=get_selected($sfl, "a.iq_name"); ?>>작성자명</option>
...
<div id="sqa">
    ...
    <li>
        ...
        <section class="sqa_section">
            <h2><?=$iq_subject; ?></h2>
			<span class="<?=$iq_style; ?>"><?=$iq_stats; ?></span>
			
            <dl class="sqa_dl">
                <dt class="sound_only">작성자</dt>
                <dd><i class="fa fa-user" aria-hidden="true"></i> <?=$row['iq_name']; ?></dd>
                <dt class="sound_only">작성일</dt>
                <dd><i class="fa fa-clock-o" aria-hidden="true"></i> <?=substr($row['iq_time'],0,10); ?></dd>
            </dl>
