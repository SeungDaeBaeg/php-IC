...
<section id="sit_use_list">
    ...
    <div class="sit_use_top">
        <?php if ($star_score) { ?>
        <h4>구매고객 총평점 <span>(총 <strong><?=$total_count; ?></strong> 건 상품평 기준)</span></h4>
    ...
    ?>
        ...
        <li class="sit_use_li">
			<span class="sit_thum"><?=get_itemuselist_thumbnail($row['it_id'], $row['is_content'], 100, 100); ?></span>
            <dl class="sit_use_dl">
                <dt>평점<dt>
                <dd class="sit_use_star"><img src="<?=G5_SHOP_URL; ?>/img/s_star<?=$is_star; ?>.png" alt="별<?=$is_star; ?>개" width="85"></dd>
                <dt></dt>
                <dd class="sit_use_tit"><?=$is_subject; ?></dd>
                <dt>작성자/작성일</dt>
                <dd><?=$is_name; ?><span class="st_bg"></span><i class="fa fa-clock-o" aria-hidden="true"></i> <?=$is_time; ?></dd>
            </dl>
